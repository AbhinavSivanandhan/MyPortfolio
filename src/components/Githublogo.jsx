...
Command: npx gltfjsx@6.2.13 githublogo.gltf --transform 
Files: githublogo.gltf [42KB] > githublogo-transformed.glb [46.85KB] (-12%)
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/githublogo-transformed.glb')
  return (
